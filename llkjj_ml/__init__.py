...
# Stelle sicher, dass logger bereits existiert, bevor Imports ausgeführt werden,
# damit im except-Block auf logger.error() zugegriffen werden kann.
logger = logging.getLogger(__name__)

# Import from parent directory (llkjj_ml root)
...
try:
    ...
    raise ImportError(
        "llkjj_ml package configuration error. "
        "Ensure the package is properly installed with 'poetry install'"
    ) from e
