...
class SentenceTransformerProvider:
    ...
    def _load_model(self) -> None:
        ...
        try:
            ...
            raise RuntimeError(f"Fehler beim Laden des Sentence Transformer Models: {e}")
...
def create_german_embedding_provider(cache_folder: Optional[Path] = None) -> SentenceTransformerProvider:
    """
...
def create_multilingual_embedding_provider(cache_folder: Optional[Path] = None) -> SentenceTransformerProvider:
    """
