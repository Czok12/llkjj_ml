...
from src.database.connection_pool import ChromaDBConnectionPool, get_chroma_pool
...
class ChromaDBBatchProcessor:
    ...
    def _update_stats(
        ...
        if batch_size > self.stats.peak_batch_size:
            self.stats.peak_batch_size = batch_size
