...
# Training System
from .src.training.spacy_trainer import SpacyTrainer, TrainingConfig, TrainingMetrics
...
def check_environment() -> dict:
    ...
    return {
        ...
        "checks": checks,
        "missing_requirements": [name for name, status in checks.items() if not status],
    }
