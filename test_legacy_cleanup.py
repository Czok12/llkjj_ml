...
class TestLegacyCleanup:
    ...
    def test_legacy_plugin_deprecation(self):
        ...
        with warnings.catch_warnings(record=True) as w:
            ...
            try:
                plugin = MLPlugin(validate_env=False)
        ...
        with warnings.catch_warnings(record=True) as w:
            ...
            try:
                ...
                with patch('llkjj_ml_plugin.MLPlugin') as mock_plugin:
                    ...
                    # This should trigger deprecation warning
                    result = process_pdf_simple("/fake/path.pdf")
    ...
    def test_no_active_singletons(self):
        ...
        assert getattr(processor, '_resource_manager', None) is None, \
        ...
        try:
            ...
            assert getattr(unified, 'resource_manager', None) is None, \
    ...
    def test_chromadb_references_eliminated(self):
        ...
        try:
            ...
            with warnings.catch_warnings():
                ...
                assert hasattr(manager, '_chroma_client')  # Should exist but be None or deprecated
...
class TestV2APIFunctionality:
    ...
    def mock_gemini_client(self):
        ...
        client = Mock()
        client.process_pdf_direct = AsyncMock(return_value={
            "success": True,
            "invoice_items": [{"description": "Test Item", "skr03_account": "3400"}]
        })
        return client
    ...
    def test_v2_plugin_creation(self, mock_repository, mock_gemini_client, mock_embedding_provider):
    ...
    @pytest.mark.asyncio
    async def test_v2_plugin_processing(self, mock_repository, mock_gemini_client, mock_embedding_provider):
